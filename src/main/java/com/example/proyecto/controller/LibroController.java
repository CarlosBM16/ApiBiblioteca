...
public class LibroController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<LibroDTO> actualizarLibro(@PathVariable("id") Long id, @Valid @RequestBody LibroUpdateDTO dto) {
        LibroDTO libroActualizado = libroService.actualizarLibro(id, dto);
